            ...
            <br>
               ...
               <table border="1" class="responsive-table" >
                  <h2 style="text-align: center;">진단서</h2>
                     <thead>
                        <tr>
                           <th width="15%" style="text-align: center;">진단명</th><td> ${data.td_title }</td>
                        </tr>
                        <tr>
                           <th style="text-align: center;">내원여부</th><td> ${data.td_inter }</td>
                        </tr>
                        <tr>
                           <th style="text-align: center;">처방약</th><td> ${data.td_medicine }</td>
                        </tr>
                        <tr>
                           <th style="text-align: center;">진단결과</th><td colspan="2">${data.td_content }</td>
                        </tr>
                        <tr>
                           <td colspan="2" style="text-align: center;">
                           <input type="button" onclick="location.href='tdboard?page=1'" value="목록">
                           <input type="button" onclick="location.href='tddform?tp_num=${data.tp_num }&page=${page}'" value="삭제">
                           </td>
                        </tr>
                     </thead>
                  </table>
