					...
					<div class="col-sm-6 col-lg-4 all pizza">
						<div class="box">
							<div>
								...
								<input type="hidden" id="product_category" name="product_category" value = "${list.product_category}">
								<input type="hidden" id="product_type" name="product_type" value= "${list.product_type}">
		...
		<div class="pages">
			<ul class="paginations modals">
				<c:if test="${pageMaker.prev}">
					<li>
						<a href='/product/shopproduct?page=${pageMaker.startPage-1 }&product_type=${list.product_type}&product_type=${list.product_category}' class="arrow left">!!!</a>
					</li>
				</c:if>
				...
				<c:if test="${pageMaker.next && pageMaker.endPage > 0}">
					<li>
						<a href='/product/shopproduct?page=${pageMaker.startPage+1 }&product_type=${list.product_type}&product_type=${list.product_category}' class="arrow right">!!!</a>
					</li>
				</c:if>
			</ul>
	    </div>
