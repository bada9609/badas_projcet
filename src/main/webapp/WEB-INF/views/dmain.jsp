            ...
            <div class="slidewrap">
               ...
               <ul class="slidelist">
                  ...
                  <li class="slideitem"><a>
                         <img src="./resources/images/dmain1.jpg" style="width:1200px;height:600px">
                  </a></li>
                  <li class="slideitem"><a>

                        <img src="./resources/images/dmain2.jpg" style="width:1200px;height:600px">
                  </a></li>
                  <li class="slideitem"><a>

                        <img src="./resources/images/dmain3.jpg" style="width:1200px;height:600px">
